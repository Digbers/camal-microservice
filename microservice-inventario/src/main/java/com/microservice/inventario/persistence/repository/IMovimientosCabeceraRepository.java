...
@Repository
public interface IMovimientosCabeceraRepository extends JpaRepository<MovimientosCabeceraEntity, Long>, JpaSpecificationExecutor<MovimientosCabeceraEntity> {
